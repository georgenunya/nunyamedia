/*!-----------------------------------------------------------------
    Name: NunyaMedia - Minimal & Clean Portfolio HTML Template
    Version: 1.0.4
    Author: robirurk, nK
...
var NunyaMedia = /*#__PURE__*/function () {
  function NunyaMedia() {
    _classCallCheck(this, NunyaMedia);

    this.options = _parts_options__WEBPACK_IMPORTED_MODULE_0__["options"];
  }

  _createClass(NunyaMedia, [{
    key: "init",
    value: function init() {
      var self = this;
      self.initNavbar();
...
window.NunyaMedia = new NunyaMedia();
